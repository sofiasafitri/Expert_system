                        ...
                        <form method="post" action="<?= base_url('auth/action.php?update-profile=' . $user_id); ?>">
                            <div class="row g-4 mb-4">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="fullname" class="form-control <?= isset($_SESSION['errors']['fullname']) ? 'is-invalid' : '' ?>" id="fullname" placeholder="Salmon" value="<?= $fullname; ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="phone" class="form-control <?= isset($_SESSION['errors']['phone']) ? 'is-invalid' : '' ?>" id="phone" placeholder="08********" value="<?= $phone; ?>">
                                        <div class="invalid-feedback">
