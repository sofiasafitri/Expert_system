        ...
        <div class="col-12 col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    $symptom_name = isset($_SESSION['form_data']['symptom_name']) ? htmlspecialchars($_SESSION['form_data']['symptom_name']) : '';
                    ?>
                    ...
                    <form method="post" action="<?= base_url('dashboard/symptom/action.php'); ?>">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <button type="submit" class="btn btn-primary text-white px-3" name="create-symptom">Simpan</button>
                        </div>
                    </form>
