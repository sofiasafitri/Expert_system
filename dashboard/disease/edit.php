        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="<?= base_url('dashboard/disease/action.php'); ?>" enctype="multipart/form-data" data-form-page="edit">
                            ...
                            <div class="col-md-4">
                                <label for="img" class="form-label d-flex justify-content-center">
                                    <div class="ratio ratio-4x3 img-show">
                                        <img id="preview-img" src="<?= get_image_url(base_url('assets/img/disease/' . $img)); ?>" alt="Pratinjau Gambar" class="rounded-3 object-fit-cover cursor-pointer img-preview">
                                    </div>
                                </label>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <button type="submit" class="btn btn-primary text-white px-3" name="update-disease">Simpan</button>
                        </div>
                    </form>
