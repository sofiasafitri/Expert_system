...
$page_name = 'Ubah Basis Pengetahuan';

// Ambil ID konsultasi dari parameter GET
$kb_id = htmlspecialchars($_GET['kb-id']) ?? 0;
$query = $connection->query("SELECT * FROM knowledge_bases WHERE id = '$kb_id'");
        ...
        <div class="col-12 col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    $mb_value = $result['mb_value'];
                    $md_value = $result['md_value'];
                    ?>
                    ...
                    <form method="post" action="<?= base_url('dashboard/knowledge-base/action.php'); ?>">
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-md-12">
                                ...
                                <select class="form-select <?= isset($_SESSION['errors']['disease_id']) ? 'is-invalid' : '' ?>" id="disease_id" name="disease_id">
                                    ...
                                    ?>
                                        <option value="<?= $result_disease['id']; ?>" <?= ($disease_id == $result_disease['id']) ? 'selected' : ''; ?>><?= htmlspecialchars($result_disease['disease_name']); ?></option>
                                    <?php endwhile; ?>
                                </select>
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-select <?= isset($_SESSION['errors']['symptom_id']) ? 'is-invalid' : '' ?>" id="symptom_id" name="symptom_id">
                                    ...
                                    ?>
                                        <option value="<?= $result_symptom['id']; ?>" <?= ($symptom_id == $result_symptom['id']) ? 'selected' : ''; ?>><?= htmlspecialchars($result_symptom['symptom_name']); ?></option>
                                    <?php endwhile; ?>
                                </select>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-select <?= isset($_SESSION['errors']['mb_value']) ? 'is-invalid' : '' ?>" id="mb_value" name="mb_value">
                                    ...
                                    foreach ($mb_values as $value) {
                                        $selected = ($mb_value == (string)$value) ? 'selected' : '';
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-select <?= isset($_SESSION['errors']['md_value']) ? 'is-invalid' : '' ?>" id="md_value" name="md_value">
                                    ...
                                    foreach ($md_values as $value) {
                                        $selected = ($md_value == (string)$value) ? 'selected' : '';
                                        echo "<option value=\"$value\" $selected>$value</option>";
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <button type="submit" class="btn btn-primary text-white px-3" name="update-kb">Simpan</button>
                        </div>
                    </form>
